...
from kanjize import kanji2int, int2kanji, Number, kanji2number
...
class TestKanjize(unittest.TestCase):
    ...
    def test_kanji2int(self):
        ...
        self.assertEqual(1234, kanji2int("一千二百三十四"))
        self.assertEqual(1234, kanji2int("千二百三十四"))
    ...
    def test_int2kanji(self):
        ...
        # added 1.2.0
        self.assertEqual(int2kanji(-150_000_000, style="mixed"), "-1億5千万")
        self.assertEqual(int2kanji(-250_320, style="mixed"), "-25万320")
        self.assertEqual(int2kanji(-150_250_320, style="mixed"), "-1億5025万320")
